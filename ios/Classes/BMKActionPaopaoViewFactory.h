...
@interface BMKActionPaopaoViewFactory : NSObject <FlutterPlatformViewFactory>
- (instancetype)initWithRegistrar:(NSObject <FlutterPluginRegistrar> *)registrar;
@end

@interface BMKActionPaopaoViewPlatformView : NSObject <BMKMapViewDelegate, BMKOfflineMapDelegate, FlutterPlatformView>
