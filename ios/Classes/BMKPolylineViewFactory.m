...
@implementation BMKPolylineViewFactory {
}
...
- (NSObject <FlutterPlatformView> *)createWithFrame:(CGRect)frame viewIdentifier:(int64_t)viewId arguments:(id _Nullable)args {
  return [[BMKPolylineViewPlatformView alloc] initWithViewId:viewId frame: frame registrar:_registrar arguments: args];
}

@end

@implementation BMKPolylineViewPlatformView {
  int64_t _viewId;
  CGRect _frame;
...
- (UIView *)view {
  ...
  if (_view == nil) {
    ...
    _view = [[BMKPolylineView alloc] initWithFrame:_frame];
    ...
    HEAP[[NSString stringWithFormat:@"%@:%@", @"BMKPolylineView", @(_view.hash)]] = _view;
  }

  //region method call handler
  FlutterMethodChannel *channel = [FlutterMethodChannel
        methodChannelWithName:@"me.yohom/bmap_map_fluttify/BMKPolylineView"
  ...
  [channel setMethodCallHandler:^(FlutterMethodCall *methodCall, FlutterResult methodResult) {
    ...
    if (strongSelf != nil) {
      ...
      methodResult([FlutterError errorWithCode:@"当前PlatformView为nil"
                                       ...
                                       details:[NSString stringWithFormat:@"请不要在 %@ 释放后继续调用其对象的方法", NSStringFromClass([BMKPolylineView class])]]);
    }
  }];
  //endregion
