...
@implementation BMKPolygonViewFactory {
}
...
- (NSObject <FlutterPlatformView> *)createWithFrame:(CGRect)frame viewIdentifier:(int64_t)viewId arguments:(id _Nullable)args {
  return [[BMKPolygonViewPlatformView alloc] initWithViewId:viewId frame: frame registrar:_registrar arguments: args];
}

@end

@implementation BMKPolygonViewPlatformView {
  int64_t _viewId;
  CGRect _frame;
...
- (UIView *)view {
  ...
  if (_view == nil) {
    ...
    _view = [[BMKPolygonView alloc] initWithFrame:_frame];
    ...
    HEAP[[NSString stringWithFormat:@"%@:%@", @"BMKPolygonView", @(_view.hash)]] = _view;
  }

  //region method call handler
  FlutterMethodChannel *channel = [FlutterMethodChannel
        methodChannelWithName:@"me.yohom/bmap_map_fluttify/BMKPolygonView"
  ...
  [channel setMethodCallHandler:^(FlutterMethodCall *methodCall, FlutterResult methodResult) {
    ...
    if (strongSelf != nil) {
      ...
      methodResult([FlutterError errorWithCode:@"当前PlatformView为nil"
                                       ...
                                       details:[NSString stringWithFormat:@"请不要在 %@ 释放后继续调用其对象的方法", NSStringFromClass([BMKPolygonView class])]]);
    }
  }];
  //endregion
