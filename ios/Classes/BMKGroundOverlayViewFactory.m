...
- (NSObject <FlutterPlatformView> *)createWithFrame:(CGRect)frame viewIdentifier:(int64_t)viewId arguments:(id _Nullable)args {
  return [[BMKGroundOverlayViewPlatformView alloc] initWithViewId:viewId frame: frame registrar:_registrar];
}
...
- (UIView *)view {
  BMKGroundOverlayView *view = [[BMKGroundOverlayView alloc] initWithFrame:_frame];
