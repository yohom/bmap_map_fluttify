...
@implementation BMKPinAnnotationViewFactory {
}
...
- (NSObject <FlutterPlatformView> *)createWithFrame:(CGRect)frame viewIdentifier:(int64_t)viewId arguments:(id _Nullable)args {
  return [[BMKPinAnnotationViewPlatformView alloc] initWithViewId:viewId frame: frame registrar:_registrar arguments: args];
}

@end

@implementation BMKPinAnnotationViewPlatformView {
  int64_t _viewId;
  CGRect _frame;
  NSDictionary<NSString *, Handler>* _handlerMap;
  BMKPinAnnotationView* _view;
  id _args;
}
...
- (UIView *)view {
  ...
  if (_view == nil) {
    ...
    _view = [[BMKPinAnnotationView alloc] initWithFrame:_frame];
    ...
    HEAP[[NSString stringWithFormat:@"%@:%@", @"BMKPinAnnotationView", @(_view.hash)]] = _view;
  }

  //region method call handler
  FlutterMethodChannel *channel = [FlutterMethodChannel
        methodChannelWithName:@"me.yohom/bmap_map_fluttify/BMKPinAnnotationView"
  ...
  [channel setMethodCallHandler:^(FlutterMethodCall *methodCall, FlutterResult methodResult) {
    ...
    if (strongSelf != nil) {
      ...
      methodResult([FlutterError errorWithCode:@"当前PlatformView为nil"
                                       ...
                                       details:[NSString stringWithFormat:@"请不要在 %@ 释放后继续调用其对象的方法", NSStringFromClass([BMKPinAnnotationView class])]]);
    }
  }];
  //endregion
