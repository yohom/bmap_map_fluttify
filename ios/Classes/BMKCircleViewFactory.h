...
@interface BMKCircleViewFactory : NSObject <FlutterPlatformViewFactory>
...
@interface BMKCircleViewPlatformView : NSObject <BMKMapViewDelegate, BMKOfflineMapDelegate, FlutterPlatformView>
