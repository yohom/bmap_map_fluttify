...
@interface BMKGroundOverlayViewFactory : NSObject <FlutterPlatformViewFactory>
...
@interface BMKGroundOverlayViewPlatformView : NSObject <BMKMapViewDelegate, BMKOfflineMapDelegate, FlutterPlatformView>
