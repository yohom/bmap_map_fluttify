...
- (NSObject <FlutterPlatformView> *)createWithFrame:(CGRect)frame viewIdentifier:(int64_t)viewId arguments:(id _Nullable)args {
  return [[BMKArclineViewPlatformView alloc] initWithViewId:viewId frame: frame registrar:_registrar];
}
...
- (UIView *)view {
  ...
  FlutterMethodChannel *channel = [FlutterMethodChannel
      methodChannelWithName:@"com.fluttify/bmap_map_fluttify/BMKArclineView"
