...
@interface BMKAnnotationViewFactory : NSObject <FlutterPlatformViewFactory>
...
@interface BMKAnnotationViewPlatformView : NSObject <BMKMapViewDelegate, BMKOfflineMapDelegate, FlutterPlatformView>
