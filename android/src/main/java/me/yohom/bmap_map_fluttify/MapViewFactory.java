...
class MapViewFactory extends PlatformViewFactory {
    ...
    MapViewFactory(BinaryMessenger messenger, Activity activity) {
        ...
        new MethodChannel(messenger, "me.yohom/bmap_map_fluttify/com_baidu_mapapi_map_MapView", new StandardMethodCodec(new FluttifyMessageCodec())).setMethodCallHandler((methodCall, methodResult) -> {
    ...
    public PlatformView create(Context context, int id, Object params) {
        ...
        getHEAP().put("com.baidu.mapapi.map.MapView:" + String.valueOf(System.identityHashCode(view)), view);
