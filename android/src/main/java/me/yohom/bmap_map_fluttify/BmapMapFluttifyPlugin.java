...
package me.yohom.bmap_map_fluttify;
...
import me.yohom.bmap_map_fluttify.sub_handler.*;
import me.yohom.bmap_map_fluttify.sub_handler.custom.SubHandlerCustom;
...
public class BmapMapFluttifyPlugin implements FlutterPlugin, MethodChannel.MethodCallHandler, ActivityAware {
    ...
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "me.yohom/bmap_map_fluttify", new StandardMethodCodec(new FluttifyMessageCodec()));
        ...
        platformViewRegistry.registerViewFactory("me.yohom/com.baidu.mapapi.map.TextureMapView", new TextureMapViewFactory(messenger, activity));
        platformViewRegistry.registerViewFactory("me.yohom/com.baidu.mapapi.map.MapView", new MapViewFactory(messenger, activity));
    }
    ...
    public void onAttachedToEngine(FlutterPluginBinding binding) {
        ...
        final MethodChannel channel = new MethodChannel(binding.getBinaryMessenger(), "me.yohom/bmap_map_fluttify", new StandardMethodCodec(new FluttifyMessageCodec()));
