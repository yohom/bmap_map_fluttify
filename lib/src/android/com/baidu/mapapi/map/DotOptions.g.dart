...
class com_baidu_mapapi_map_DotOptions extends com_baidu_mapapi_map_OverlayOptions  {
  ...
  Future<com_baidu_mapapi_map_DotOptions> center(com_baidu_mapapi_model_LatLng var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.map.DotOptions::center', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
  ...
  Future<com_baidu_mapapi_map_DotOptions> extraInfo(android_os_Bundle var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.map.DotOptions::extraInfo', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
