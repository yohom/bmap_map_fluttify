...
class com_baidu_mapapi_map_offline_OfflineMapUtil extends java_lang_Object  {
  //region constants
  ...
  static Future<com_baidu_mapapi_map_offline_OfflineMapUtil> create__() async {
    final refId = await MethodChannel('com.fluttify/bmap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec('bmap_map_fluttify'))).invokeMethod('ObjectFactory::createcom_baidu_mapapi_map_offline_OfflineMapUtil__', );
  ...
  static Future<List<com_baidu_mapapi_map_offline_OfflineMapUtil>> create_batch__(int length) async {
    ...
    final List resultBatch = await MethodChannel('com.fluttify/bmap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec('bmap_map_fluttify'))).invokeMethod('ObjectFactory::create_batchcom_baidu_mapapi_map_offline_OfflineMapUtil__', {'length': length});
