...
class com_baidu_mapapi_map_offline_OfflineMapUtil extends java_lang_Object  {
  ...
  static Future<com_baidu_mapapi_map_offline_OfflineMapUtil> create__() async {
    ...
    final object = com_baidu_mapapi_map_offline_OfflineMapUtil()..refId = refId..tag = 'bmap_map_fluttify';
  ...
  static Future<List<com_baidu_mapapi_map_offline_OfflineMapUtil>> create_batch__(int length) async {
    ...
    final List<com_baidu_mapapi_map_offline_OfflineMapUtil> typedResult = resultBatch.map((result) => com_baidu_mapapi_map_offline_OfflineMapUtil()..refId = result..tag = 'bmap_map_fluttify').toList();
