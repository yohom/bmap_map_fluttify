...
class com_baidu_mapapi_map_PolylineOptions extends com_baidu_mapapi_map_OverlayOptions  {
  ...
  Future<com_baidu_mapapi_map_PolylineOptions> color(int var1) async {
    ...
    if (__result__ == null) {
      ...
      kNativeObjectPool.add(com_baidu_mapapi_map_PolylineOptions()..refId = __result__..tag__ = 'bmap_map_fluttify');
      return com_baidu_mapapi_map_PolylineOptions()..refId = __result__..tag__ = 'bmap_map_fluttify';
    }
  }
  ...
  Future<com_baidu_mapapi_map_PolylineOptions> dottedLineType(com_baidu_mapapi_map_PolylineDottedLineType var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.map.PolylineOptions::dottedLineType', {"var1": var1.index, "refId": refId});
...
extension com_baidu_mapapi_map_PolylineOptions_Batch on List<com_baidu_mapapi_map_PolylineOptions> {
  ...
  Future<List<com_baidu_mapapi_map_PolylineOptions>> dottedLineType_batch(List<com_baidu_mapapi_map_PolylineDottedLineType> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.map.PolylineOptions::dottedLineType_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__].index, "refId": this[__i__].refId}]);
