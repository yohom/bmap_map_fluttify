...
class com_baidu_mapapi_map_TileOverlayOptions extends java_lang_Object  {
  ...
  Future<com_baidu_mapapi_map_TileOverlayOptions> tileProvider(com_baidu_mapapi_map_TileProvider var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.map.TileOverlayOptions::tileProvider', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
  ...
  Future<com_baidu_mapapi_map_TileOverlayOptions> setPositionFromBounds(com_baidu_mapapi_model_LatLngBounds var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.map.TileOverlayOptions::setPositionFromBounds', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
