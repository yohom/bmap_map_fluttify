...
class com_baidu_mapapi_model_LatLngBounds_Builder extends java_lang_Object  {
  ...
  static Future<com_baidu_mapapi_model_LatLngBounds_Builder> create__() async {
    ...
    final object = com_baidu_mapapi_model_LatLngBounds_Builder()..refId = refId..tag = 'bmap_map_fluttify';
  ...
  static Future<List<com_baidu_mapapi_model_LatLngBounds_Builder>> create_batch__(int length) async {
    ...
    final List<com_baidu_mapapi_model_LatLngBounds_Builder> typedResult = resultBatch.map((result) => com_baidu_mapapi_model_LatLngBounds_Builder()..refId = result..tag = 'bmap_map_fluttify').toList();
  ...
  Future<com_baidu_mapapi_model_LatLngBounds> build() async {
    ...
    final result = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.model.LatLngBounds.Builder::build', {"refId": refId});
  ...
  Future<com_baidu_mapapi_model_LatLngBounds_Builder> include__com_baidu_mapapi_model_LatLng(com_baidu_mapapi_model_LatLng var1) async {
    ...
    // invoke native method
    final result = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.model.LatLngBounds.Builder::include__com_baidu_mapapi_model_LatLng', {"var1": var1.refId, "refId": refId});
    ...
    if (result == null) {
      ...
      kNativeObjectPool.add(com_baidu_mapapi_model_LatLngBounds_Builder()..refId = result..tag = 'bmap_map_fluttify');
      return com_baidu_mapapi_model_LatLngBounds_Builder()..refId = result..tag = 'bmap_map_fluttify';
    }
  }
...
extension com_baidu_mapapi_model_LatLngBounds_Builder_Batch on List<com_baidu_mapapi_model_LatLngBounds_Builder> {
  ...
  Future<List<com_baidu_mapapi_model_LatLngBounds>> build_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.model.LatLngBounds.Builder::build_batch', [for (int i = 0; i < this.length; i++) {"refId": this[i].refId}]);
  ...
  Future<List<com_baidu_mapapi_model_LatLngBounds_Builder>> include__com_baidu_mapapi_model_LatLng_batch(List<com_baidu_mapapi_model_LatLng> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.model.LatLngBounds.Builder::include__com_baidu_mapapi_model_LatLng_batch', [for (int i = 0; i < this.length; i++) {"var1": var1[i].refId, "refId": this[i].refId}]);
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((result) => com_baidu_mapapi_model_LatLngBounds_Builder()..refId = result..tag = 'bmap_map_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
