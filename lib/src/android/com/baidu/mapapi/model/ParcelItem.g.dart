...
class com_baidu_mapapi_model_ParcelItem extends java_lang_Object with android_os_Parcelable {
  ...
  Future<void> setBundle(android_os_Bundle var1) async {
    ...
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.model.ParcelItem::setBundle', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
