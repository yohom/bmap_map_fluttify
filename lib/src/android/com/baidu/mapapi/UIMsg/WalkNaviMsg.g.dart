...
class com_baidu_mapapi_UIMsg_WalkNaviMsg extends java_lang_Object  {
  ...
  static Future<com_baidu_mapapi_UIMsg_WalkNaviMsg> create__() async {
    ...
    final object = com_baidu_mapapi_UIMsg_WalkNaviMsg()..refId = refId..tag = 'bmap_map_fluttify';
  ...
  static Future<List<com_baidu_mapapi_UIMsg_WalkNaviMsg>> create_batch__(int length) async {
    ...
    final List<com_baidu_mapapi_UIMsg_WalkNaviMsg> typedResult = resultBatch.map((result) => com_baidu_mapapi_UIMsg_WalkNaviMsg()..refId = result..tag = 'bmap_map_fluttify').toList();
