...
class com_baidu_mapapi_utils_SpatialRelationUtil extends java_lang_Object  {
  ...
  static Future<com_baidu_mapapi_utils_SpatialRelationUtil> create__() async {
    final refId = await MethodChannel('com.fluttify/bmap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec('bmap_map_fluttify'))).invokeMethod('ObjectFactory::createcom_baidu_mapapi_utils_SpatialRelationUtil__', );
  ...
  static Future<List<com_baidu_mapapi_utils_SpatialRelationUtil>> create_batch__(int length) async {
    ...
    final List resultBatch = await MethodChannel('com.fluttify/bmap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec('bmap_map_fluttify'))).invokeMethod('ObjectFactory::create_batchcom_baidu_mapapi_utils_SpatialRelationUtil__', {'length': length});
  ...
  static Future<bool> isPolygonContainsPoint(List<com_baidu_mapapi_model_LatLng> var0, com_baidu_mapapi_model_LatLng var1) async {
    ...
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec('bmap_map_fluttify'))).invokeMethod('com.baidu.mapapi.utils.SpatialRelationUtil::isPolygonContainsPoint', {"var0": var0, "var1": var1});
  ...
  static Future<bool> isCircleContainsPoint(com_baidu_mapapi_model_LatLng var0, int var1, com_baidu_mapapi_model_LatLng var2) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec('bmap_map_fluttify'))).invokeMethod('com.baidu.mapapi.utils.SpatialRelationUtil::isCircleContainsPoint', {"var0": var0, "var1": var1, "var2": var2});
  ...
  static Future<com_baidu_mapapi_model_LatLng> getNearestPointFromLine(List<com_baidu_mapapi_model_LatLng> var0, com_baidu_mapapi_model_LatLng var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec('bmap_map_fluttify'))).invokeMethod('com.baidu.mapapi.utils.SpatialRelationUtil::getNearestPointFromLine', {"var0": var0, "var1": var1});
...
extension com_baidu_mapapi_utils_SpatialRelationUtil_Batch on List<com_baidu_mapapi_utils_SpatialRelationUtil> {
  ...
  static Future<List<bool>> isPolygonContainsPoint_batch(List<List<com_baidu_mapapi_model_LatLng>> var0, List<com_baidu_mapapi_model_LatLng> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/bmap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec('bmap_map_fluttify'))).invokeMethod('com.baidu.mapapi.utils.SpatialRelationUtil::isPolygonContainsPoint_batch', [for (int __i__ = 0; __i__ < var0.length; __i__++) {"var0": var0[__i__], "var1": var1[__i__]}]);
  ...
  static Future<List<bool>> isCircleContainsPoint_batch(List<com_baidu_mapapi_model_LatLng> var0, List<int> var1, List<com_baidu_mapapi_model_LatLng> var2) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/bmap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec('bmap_map_fluttify'))).invokeMethod('com.baidu.mapapi.utils.SpatialRelationUtil::isCircleContainsPoint_batch', [for (int __i__ = 0; __i__ < var0.length; __i__++) {"var0": var0[__i__], "var1": var1[__i__], "var2": var2[__i__]}]);
  ...
  static Future<List<com_baidu_mapapi_model_LatLng>> getNearestPointFromLine_batch(List<List<com_baidu_mapapi_model_LatLng>> var0, List<com_baidu_mapapi_model_LatLng> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/bmap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec('bmap_map_fluttify'))).invokeMethod('com.baidu.mapapi.utils.SpatialRelationUtil::getNearestPointFromLine_batch', [for (int __i__ = 0; __i__ < var0.length; __i__++) {"var0": var0[__i__], "var1": var1[__i__]}]);
