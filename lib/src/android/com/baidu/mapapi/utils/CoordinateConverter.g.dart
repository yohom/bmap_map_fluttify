...
class com_baidu_mapapi_utils_CoordinateConverter extends java_lang_Object  {
  ...
  Future<com_baidu_mapapi_utils_CoordinateConverter> coord(com_baidu_mapapi_model_LatLng var1) async {
    ...
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.utils.CoordinateConverter::coord', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
  ...
  Future<com_baidu_mapapi_utils_CoordinateConverter> from(com_baidu_mapapi_utils_CoordinateConverter_CoordType var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.utils.CoordinateConverter::from', {"var1": var1.toValue(), "refId": refId});
  ...
  Future<com_baidu_mapapi_model_LatLng> convert() async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.utils.CoordinateConverter::convert', {"refId": refId});
...
extension com_baidu_mapapi_utils_CoordinateConverter_Batch on List<com_baidu_mapapi_utils_CoordinateConverter> {
  ...
  Future<List<com_baidu_mapapi_utils_CoordinateConverter>> coord_batch(List<com_baidu_mapapi_model_LatLng> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.utils.CoordinateConverter::coord_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__].refId, "refId": this[__i__].refId}]);
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<int>().map((__result__) => com_baidu_mapapi_utils_CoordinateConverter()..refId = __result__..tag__ = 'bmap_map_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
  ...
  Future<List<com_baidu_mapapi_utils_CoordinateConverter>> from_batch(List<com_baidu_mapapi_utils_CoordinateConverter_CoordType> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.utils.CoordinateConverter::from_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__].toValue(), "refId": this[__i__].refId}]);
  ...
  Future<List<com_baidu_mapapi_model_LatLng>> convert_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.utils.CoordinateConverter::convert_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
