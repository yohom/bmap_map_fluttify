...
class com_baidu_mapapi_utils_route_IllegalRoutePlanArgumentException extends java_lang_Object  {
  ...
  static Future<List<com_baidu_mapapi_utils_route_IllegalRoutePlanArgumentException>> create_batch__String(List<String> var1) async {
    ...
    final List resultBatch = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('ObjectFactory::create_batchcom_baidu_mapapi_utils_route_IllegalRoutePlanArgumentException__String', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__]}]);
