...
class com_baidu_mapapi_navi_IllegalNaviArgumentException extends java_lang_Object  {
  ...
  static Future<com_baidu_mapapi_navi_IllegalNaviArgumentException> create__() async {
    ...
    final object = com_baidu_mapapi_navi_IllegalNaviArgumentException()..refId = refId..tag = 'bmap_map_fluttify';
  ...
  static Future<List<com_baidu_mapapi_navi_IllegalNaviArgumentException>> create_batch__(int length) async {
    ...
    final List<com_baidu_mapapi_navi_IllegalNaviArgumentException> typedResult = resultBatch.map((result) => com_baidu_mapapi_navi_IllegalNaviArgumentException()..refId = result..tag = 'bmap_map_fluttify').toList();
  ...
  static Future<List<com_baidu_mapapi_navi_IllegalNaviArgumentException>> create_batch__String(List<String> var1) async {
    ...
    //   return Future.error('all args must has same length!');
    // }
    final List resultBatch = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('ObjectFactory::create_batchcom_baidu_mapapi_navi_IllegalNaviArgumentException__String', [for (int i = 0; i < var1.length; i++) {"var1": var1[i]}]);
