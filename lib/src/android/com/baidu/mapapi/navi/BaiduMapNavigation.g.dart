...
class com_baidu_mapapi_navi_BaiduMapNavigation extends java_lang_Object  {
  ...
  static Future<bool> openBaiduMapNavi(com_baidu_mapapi_navi_NaviParaOption var0, android_content_Context var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.navi.BaiduMapNavigation::openBaiduMapNavi', {"var0": var0 is Ref ? (var0 as Ref)?.refId : var0, "var1": var1 is Ref ? (var1 as Ref)?.refId : var1});
  ...
  static Future<bool> openBaiduMapWalkNavi(com_baidu_mapapi_navi_NaviParaOption var0, android_content_Context var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.navi.BaiduMapNavigation::openBaiduMapWalkNavi', {"var0": var0 is Ref ? (var0 as Ref)?.refId : var0, "var1": var1 is Ref ? (var1 as Ref)?.refId : var1});
  ...
  static Future<bool> openBaiduMapWalkNaviAR(com_baidu_mapapi_navi_NaviParaOption var0, android_content_Context var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.navi.BaiduMapNavigation::openBaiduMapWalkNaviAR', {"var0": var0 is Ref ? (var0 as Ref)?.refId : var0, "var1": var1 is Ref ? (var1 as Ref)?.refId : var1});
  ...
  static Future<bool> openBaiduMapBikeNavi(com_baidu_mapapi_navi_NaviParaOption var0, android_content_Context var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.navi.BaiduMapNavigation::openBaiduMapBikeNavi', {"var0": var0 is Ref ? (var0 as Ref)?.refId : var0, "var1": var1 is Ref ? (var1 as Ref)?.refId : var1});
  ...
  static Future<void> openWebBaiduMapNavi(com_baidu_mapapi_navi_NaviParaOption var0, android_content_Context var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.navi.BaiduMapNavigation::openWebBaiduMapNavi', {"var0": var0 is Ref ? (var0 as Ref)?.refId : var0, "var1": var1 is Ref ? (var1 as Ref)?.refId : var1});
  ...
  static Future<void> finish(android_content_Context var0) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.navi.BaiduMapNavigation::finish', {"var0": var0 is Ref ? (var0 as Ref)?.refId : var0});
