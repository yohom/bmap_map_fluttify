...
class com_baidu_mapapi_search_busline_BusLineSearch extends java_lang_Object  {
  ...
  static Future<com_baidu_mapapi_search_busline_BusLineSearch> newInstance() async {
    ...
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.search.busline.BusLineSearch::newInstance', );
  ...
  Future<bool> searchBusLine(com_baidu_mapapi_search_busline_BusLineSearchOption var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.search.busline.BusLineSearch::searchBusLine', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
  ...
  Future<void> setOnGetBusLineSearchResultListener(com_baidu_mapapi_search_busline_OnGetBusLineSearchResultListener var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.search.busline.BusLineSearch::setOnGetBusLineSearchResultListener', {"refId": refId});
  ...
  Future<void> destroy() async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.search.busline.BusLineSearch::destroy', {"refId": refId});
...
extension com_baidu_mapapi_search_busline_BusLineSearch_Batch on List<com_baidu_mapapi_search_busline_BusLineSearch> {
  ...
  static Future<List<com_baidu_mapapi_search_busline_BusLineSearch>> newInstance_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.search.busline.BusLineSearch::newInstance_batch', );
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).cast<int>().map((__result__) => com_baidu_mapapi_search_busline_BusLineSearch()..refId = __result__..tag__ = 'bmap_map_fluttify').toList();
  ...
  Future<List<bool>> searchBusLine_batch(List<com_baidu_mapapi_search_busline_BusLineSearchOption> var1) async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.search.busline.BusLineSearch::searchBusLine_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"var1": var1[__i__].refId, "refId": this[__i__].refId}]);
  ...
  Future<List<void>> destroy_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.search.busline.BusLineSearch::destroy_batch', [for (int __i__ = 0; __i__ < this.length; __i__++) {"refId": this[__i__].refId}]);
