...
class com_baidu_mapapi_search_busline_BusLineSearch extends java_lang_Object  {
  ...
  Future<bool> searchBusLine(com_baidu_mapapi_search_busline_BusLineSearchOption var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.search.busline.BusLineSearch::searchBusLine', {"var1": var1?.refId, "refId": refId});
