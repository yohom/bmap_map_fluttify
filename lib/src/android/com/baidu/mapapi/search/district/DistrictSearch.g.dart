...
class com_baidu_mapapi_search_district_DistrictSearch extends java_lang_Object  {
  ...
  Future<bool> searchDistrict(com_baidu_mapapi_search_district_DistrictSearchOption var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.search.district.DistrictSearch::searchDistrict', {"var1": var1?.refId, "refId": refId});
