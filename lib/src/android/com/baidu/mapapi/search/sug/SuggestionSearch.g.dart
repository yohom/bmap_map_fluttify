...
class com_baidu_mapapi_search_sug_SuggestionSearch extends java_lang_Object  {
  ...
  Future<bool> requestSuggestion(com_baidu_mapapi_search_sug_SuggestionSearchOption var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.search.sug.SuggestionSearch::requestSuggestion', {"var1": var1?.refId, "refId": refId});
