...
class com_baidu_mapapi_search_share_RouteShareURLOption extends java_lang_Object  {
  ...
  Future<com_baidu_mapapi_search_share_RouteShareURLOption> from(com_baidu_mapapi_search_route_PlanNode var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.search.share.RouteShareURLOption::from', {"var1": var1?.refId, "refId": refId});
  ...
  Future<com_baidu_mapapi_search_share_RouteShareURLOption> to(com_baidu_mapapi_search_route_PlanNode var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('com.fluttify/bmap_map_fluttify').invokeMethod('com.baidu.mapapi.search.share.RouteShareURLOption::to', {"var1": var1?.refId, "refId": refId});
