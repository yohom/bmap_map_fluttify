...
class com_baidu_mapsdkplatform_comapi_favrite_FavSyncPoi extends java_lang_Object  {
  ...
  static Future<com_baidu_mapsdkplatform_comapi_favrite_FavSyncPoi> create__() async {
    ...
    final object = com_baidu_mapsdkplatform_comapi_favrite_FavSyncPoi()..refId = refId..tag = 'bmap_map_fluttify';
  ...
  static Future<List<com_baidu_mapsdkplatform_comapi_favrite_FavSyncPoi>> create_batch__(int length) async {
    ...
    final List<com_baidu_mapsdkplatform_comapi_favrite_FavSyncPoi> typedResult = resultBatch.map((result) => com_baidu_mapsdkplatform_comapi_favrite_FavSyncPoi()..refId = result..tag = 'bmap_map_fluttify').toList();
