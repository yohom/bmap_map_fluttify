...
Future<bool> BmapMapFluttifyIOSIs<T>(dynamic __this__) async {
  ...
  if (RegExp(
    ...
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKActionPaopaoView', {'__this__': __this__});
    return result;
  } else if (T == BMKAnnotation) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKAnnotation', {'__this__': __this__});
    return result;
  } else if (T == BMKTileLayerView) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKTileLayerView', {'__this__': __this__});
    return result;
  } else if (T == BMKOverlayPathView) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKOverlayPathView', {'__this__': __this__});
    return result;
  } else if (T == BMKGroundOverlay) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKGroundOverlay', {'__this__': __this__});
    return result;
  } else if (T == BMKPolyline) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfBMKPolyline', {'__this__': __this__});
    return result;
  } else if (T == BMKCircleView) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKCircleView', {'__this__': __this__});
    return result;
  } else if (T == BMKPointAnnotation) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKPointAnnotation', {'__this__': __this__});
    return result;
  } else if (T == BMKGradient) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfBMKGradient', {'__this__': __this__});
    return result;
  } else if (T == BMKArcline) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfBMKArcline', {'__this__': __this__});
    return result;
  } else if (T == BMKMultiPoint) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKMultiPoint', {'__this__': __this__});
    return result;
  } else if (T == BMKBaseIndoorMapInfo) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKBaseIndoorMapInfo', {'__this__': __this__});
    return result;
  } else if (T == BMKTileLayer) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfBMKTileLayer', {'__this__': __this__});
    return result;
  } else if (T == BMKURLTileLayer) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKURLTileLayer', {'__this__': __this__});
    return result;
  } else if (T == BMKSyncTileLayer) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKSyncTileLayer', {'__this__': __this__});
    return result;
  } else if (T == BMKAsyncTileLayer) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKAsyncTileLayer', {'__this__': __this__});
    return result;
  } else if (T == BMKPolylineView) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKPolylineView', {'__this__': __this__});
    return result;
  } else if (T == BMKPinAnnotationView) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKPinAnnotationView', {'__this__': __this__});
    return result;
  } else if (T == BMKCircle) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfBMKCircle', {'__this__': __this__});
    return result;
  } else if (T == BMKMapPoi) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfBMKMapPoi', {'__this__': __this__});
    return result;
  } else if (T == BMKMapView) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfBMKMapView', {'__this__': __this__});
    return result;
  } else if (T == BMKLocationViewDisplayParam) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKLocationViewDisplayParam',
        {'__this__': __this__});
    return result;
  } else if (T == BMKMapStatus) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfBMKMapStatus', {'__this__': __this__});
    return result;
  } else if (T == BMKArclineView) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKArclineView', {'__this__': __this__});
    return result;
  } else if (T == BMKHeatMapNode) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKHeatMapNode', {'__this__': __this__});
    return result;
  } else if (T == BMKHeatMap) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfBMKHeatMap', {'__this__': __this__});
    return result;
  } else if (T == BMKPolygon) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfBMKPolygon', {'__this__': __this__});
    return result;
  } else if (T == BMKPolygonView) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKPolygonView', {'__this__': __this__});
    return result;
  } else if (T == BMKOverlayView) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKOverlayView', {'__this__': __this__});
    return result;
  } else if (T == BMKGroundOverlayView) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKGroundOverlayView', {'__this__': __this__});
    return result;
  } else if (T == BMKAnnotationView) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKAnnotationView', {'__this__': __this__});
    return result;
  } else if (T == BMKOverlayGLBasicView) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKOverlayGLBasicView', {'__this__': __this__});
    return result;
  } else if (T == BMKShape) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfBMKShape', {'__this__': __this__});
    return result;
  } else if (T == BMKOLSearchRecord) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKOLSearchRecord', {'__this__': __this__});
    return result;
  } else if (T == BMKOLUpdateElement) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKOLUpdateElement', {'__this__': __this__});
    return result;
  } else if (T == BMKOverlay) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfBMKOverlay', {'__this__': __this__});
    return result;
  } else if (T == BMKCustomMapStyleOption) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKCustomMapStyleOption', {'__this__': __this__});
    return result;
  } else if (T == BMKOfflineMap) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKOfflineMap', {'__this__': __this__});
    return result;
  } else if (T == BMKLocationReGeocode) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKLocationReGeocode', {'__this__': __this__});
    return result;
  } else if (T == BMKLocationManager) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKLocationManager', {'__this__': __this__});
    return result;
  } else if (T == BMKLocationAuth) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKLocationAuth', {'__this__': __this__});
    return result;
  } else if (T == BMKLocationPoiRegion) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKLocationPoiRegion', {'__this__': __this__});
    return result;
  } else if (T == BMKLocationPoi) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKLocationPoi', {'__this__': __this__});
    return result;
  } else if (T == BMKLocation) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfBMKLocation', {'__this__': __this__});
    return result;
  } else if (T == BMKGeoFenceRegion) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKGeoFenceRegion', {'__this__': __this__});
    return result;
  } else if (T == BMKGeoFenceCircleRegion) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKGeoFenceCircleRegion', {'__this__': __this__});
    return result;
  } else if (T == BMKGeoFencePolygonRegion) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKGeoFencePolygonRegion', {'__this__': __this__});
    return result;
  } else if (T == BMKGeoFenceManager) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfBMKGeoFenceManager', {'__this__': __this__});
    return result;
  } else if (T == CLLocation) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfCLLocation', {'__this__': __this__});
    return result;
  } else if (T == CLHeading) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfCLHeading', {'__this__': __this__});
    return result;
  } else if (T == CGRect) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfCGRect', {'__this__': __this__});
    return result;
  } else if (T == CGPoint) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfCGPoint', {'__this__': __this__});
    return result;
  } else if (T == CGSize) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfCGSize', {'__this__': __this__});
    return result;
  } else if (T == UIEdgeInsets) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfUIEdgeInsets', {'__this__': __this__});
    return result;
  } else if (T == CLLocationCoordinate2D) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfCLLocationCoordinate2D', {'__this__': __this__});
    return result;
  } else if (T == CLLocationManager) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfCLLocationManager', {'__this__': __this__});
    return result;
  } else if (T == NSError) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfNSError', {'__this__': __this__});
    return result;
  } else if (T == NSCopying) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfNSCopying', {'__this__': __this__});
    return result;
  } else if (T == UIView) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfUIView', {'__this__': __this__});
    return result;
  } else if (T == UIViewController) {
    final result = await kBmapMapFluttifyChannel.invokeMethod(
        'RefClass::isKindOfUIViewController', {'__this__': __this__});
    return result;
  } else if (T == UIControl) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfUIControl', {'__this__': __this__});
    return result;
  } else if (T == UIImage) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfUIImage', {'__this__': __this__});
    return result;
  } else if (T == UIImageView) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfUIImageView', {'__this__': __this__});
    return result;
  } else if (T == UIColor) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfUIColor', {'__this__': __this__});
    return result;
  } else if (T == NSData) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfNSData', {'__this__': __this__});
    return result;
  } else if (T == NSDate) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfNSDate', {'__this__': __this__});
    return result;
  } else if (T == NSOperation) {
    final result = await kBmapMapFluttifyChannel
        .invokeMethod('RefClass::isKindOfNSOperation', {'__this__': __this__});
    return result;
  } else {
    return false;
  }
...
T BmapMapFluttifyIOSAs<T>(dynamic __this__) {
  ...
  if (__this__ == null) {
    ...
    return (BMKLocationViewDisplayParam()..refId = (__this__ as Ref).refId)
        as T;
  } else if (T == BMKMapStatus) {
