...
typedef BMKCircleViewCreatedCallback = void Function(BMKCircleView controller);
typedef _OnUiKitViewDispose = Future<void> Function();

class BMKCircleView_iOS extends StatefulWidget {
  const BMKCircleView_iOS({
    Key key,
    this.onViewCreated,
    this.onDispose,
...
class _BMKCircleView_iOSState extends State<BMKCircleView_iOS> {
  BMKCircleView _controller;
  ...
  Widget build(BuildContext context) {
    ...
    return UiKitView(
      viewType: 'me.yohom/BMKCircleView',
  ...
  void _onViewCreated(int id) async {
    ...
    _controller = BMKCircleView()..refId = 'BMKCircleView:$refId';
