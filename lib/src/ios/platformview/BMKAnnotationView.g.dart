...
typedef BMKAnnotationViewCreatedCallback = void Function(BMKAnnotationView controller);
...
class _BMKAnnotationView_iOSState extends State<BMKAnnotationView_iOS> {
  ...
  Widget build(BuildContext context) {
    ...
    return UiKitView(
      viewType: 'me.yohom/BMKAnnotationView',
  ...
  void _onViewCreated(int id) async {
    ...
    _controller = BMKAnnotationView()..refId = 'BMKAnnotationView:$refId';
