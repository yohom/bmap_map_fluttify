...
typedef void BMKOverlayViewCreatedCallback(BMKOverlayView controller);
...
class _BMKOverlayView_iOSState extends State<BMKOverlayView_iOS> {
  ...
  Widget build(BuildContext context) {
    ...
    return UiKitView(
      viewType: 'com.fluttify/BMKOverlayView',
  ...
  void _onViewCreated(int id) async {
    ...
    _controller = BMKOverlayView()..refId = refId..tag__ = 'bmap_map_fluttify';
