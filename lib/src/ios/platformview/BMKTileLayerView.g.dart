...
typedef BMKTileLayerViewCreatedCallback = void Function(BMKTileLayerView controller);
typedef _OnUiKitViewDispose = Future<void> Function();

class BMKTileLayerView_iOS extends StatefulWidget {
  const BMKTileLayerView_iOS({
    Key key,
    this.onViewCreated,
    this.onDispose,
...
class _BMKTileLayerView_iOSState extends State<BMKTileLayerView_iOS> {
  BMKTileLayerView _controller;
  ...
  Widget build(BuildContext context) {
    ...
    return UiKitView(
      viewType: 'me.yohom/BMKTileLayerView',
  ...
  void _onViewCreated(int id) async {
    ...
    _controller = BMKTileLayerView()..refId = 'BMKTileLayerView:$refId';
