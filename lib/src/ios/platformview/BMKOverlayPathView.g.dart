...
typedef BMKOverlayPathViewCreatedCallback = void Function(BMKOverlayPathView controller);
...
class _BMKOverlayPathView_iOSState extends State<BMKOverlayPathView_iOS> {
  ...
  Widget build(BuildContext context) {
    ...
    return UiKitView(
      viewType: 'me.yohom/BMKOverlayPathView',
  ...
  void _onViewCreated(int id) async {
    ...
    _controller = BMKOverlayPathView()..refId = 'BMKOverlayPathView:$refId';
