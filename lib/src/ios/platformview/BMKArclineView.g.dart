...
typedef BMKArclineViewCreatedCallback = void Function(BMKArclineView controller);
...
class _BMKArclineView_iOSState extends State<BMKArclineView_iOS> {
  ...
  Widget build(BuildContext context) {
    ...
    return UiKitView(
      viewType: 'me.yohom/BMKArclineView',
  ...
  void _onViewCreated(int id) async {
    ...
    _controller = BMKArclineView()..refId = 'BMKArclineView:$refId';
