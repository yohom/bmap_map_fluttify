...
class _BMKPolylineView_iOSState extends State<BMKPolylineView_iOS> {
  BMKPolylineView _controller;
  ...
  void _onViewCreated(int id) async {
    ...
    _controller = BMKPolylineView()..refId = refId..tag__ = 'bmap_map_fluttify';
